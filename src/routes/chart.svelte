<script lang="ts">
	import Loader_2_icon from '@lucide/svelte/icons/loader-2'
	import Play_icon from '@lucide/svelte/icons/play'
	import * as Chart from '$lib/components/ui/chart/index.js'
	import * as Card from '$lib/components/ui/card/index.js'
	import { scaleUtc } from 'd3-scale'
	import { Area, AreaChart, ChartClipPath } from 'layerchart'
	import { curveNatural } from 'd3-shape'
	import Chart_container from '$lib/components/ui/chart/chart-container.svelte'
...
<div class="relative grow rounded-md border">
	...
	<Card.Root class="blur">
		...
		<Card.Content>
			<Chart_container config={chartConfig} class="aspect-auto h-[250px] w-full">
				<AreaChart
					legend
					data={filteredData}
					x="date"
					...
					{#snippet marks({ series, getAreaProps })}
						<defs>
							<linearGradient id="fillDesktop" x1="0" y1="0" x2="0" y2="1">
								<stop offset="5%" stop-color="var(--color-desktop)" stop-opacity={1.0}></stop>
